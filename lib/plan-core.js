...
function makeOcc({ source, id, date, start, end, allDay, important, color, place, title, recurring, moved, origDate }) {
  return {
 ...
 */
export function expand(doc, classes, fromISO, toISO) {
  const out = [];
