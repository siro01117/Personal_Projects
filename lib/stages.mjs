...
export const STAGES = [
  {
    // 기능을 묻지 않고 유래를 묻는다. '~었을까' 가 추측을 부르고, 설명을 읽기 전에
    // 스스로 짚어 보는 쪽이 이해와 전이에 낫다 (문제 먼저 → 설명 나중).
    key: 'problem', group: 'big', title: '이 개념은 왜 정립됐을까',
    help: '추측이어도 된다. 무엇이 아쉬워서 이게 나왔을지. 확인 전이면 끝에 (추측)이라고 붙여 둔다.',
    kind: 'lines', ph: '예) 흩어진 정도를 눈대중 말고 한 수로 말하려고 (추측)',
    head: '이 단원이 푸는 문제',
  },
  {
    key: 'prior', group: 'big', title: '이걸 보려면 뭘 알고 있어야 하나',
  ...
  {
    key: 'rules', group: 'in', title: '어떻게 굴러가나',
    help: '결과 말고 이유나 순서. "무엇이다"가 아니라 "왜 그렇게 되나"로 한 줄씩.',
    kind: 'lines', ph: '예) 조건이 겹치면 좁은 쪽이 이긴다',
    head: '핵심 원리',
  },
  {
    key: 'terms', group: 'in', title: '새로 나온 말과 뜻',
    help: '말 한쪽, 뜻 한 줄. 교재 문장을 옮기지 말고 네 말로. 이름이 왜 그런지가 뜻을 대신하기도 한다.',
  ...
  {
    key: 'worked', group: 'in', title: '예제 하나를 끝까지',
    help: '수업에 나온 것 하나를 그대로. 답만 말고 푸는 순서를 적는다.',
    kind: 'pairs', ph: ['문제', '1. … 2. … 3. …'],
    head: '예제', th: ['문제', '푸는 순서'],
  },
  {
